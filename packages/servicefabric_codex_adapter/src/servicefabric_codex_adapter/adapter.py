"""Codex CLI translation adapter; process lifecycle remains runtime-owned."""
...
class CodexAdapter:
    """Translate Codex JSONL output into the shared provider contracts."""
    ...
    def probe(self) -> dict[str, Any]:
        ...
        return {"provider_id": self.provider_id, "executable": "codex", "protocol": "jsonl"}
    ...
    def build_argv(self, request: ProviderExecutionRequest) -> tuple[str, ...]:
        ...
        if request.provider_id != self.provider_id:
            raise ValueError("CodexAdapter only accepts provider_id 'codex'")
    ...
    def parse_event(self, raw_event: str, sequence: int) -> ProviderEvent | None:
        ...
        try:
            ...
            return ProviderEvent(
                ...
                payload={"message": "Codex emitted a non-JSON record"},
            )
