...
CREDENTIAL_STORE_ENVIRONMENT = os.environ.get('CREDENTIAL_STORE_ENVIRONMENT', os.environ.get('FABRIC_ENVIRONMENT', 'development')).lower()
CREDENTIAL_STORE_BACKEND = os.environ.get('CREDENTIAL_STORE_BACKEND', 'disabled')
CREDENTIAL_STORE_ENCRYPTION_KEY = os.environ.get('CREDENTIAL_STORE_ENCRYPTION_KEY', '')
CREDENTIAL_STORE_PATH = os.environ.get('CREDENTIAL_STORE_PATH', str(BASE_DIR / 'credential-store.dev.json'))
