...
class McpGatewayService:
 ...
 def initialize(self,*,session_id,caller,adapter_ref,capabilities,now):return self._sessions.initialize(session_id=session_id,caller=caller,adapter_ref=adapter_ref,capabilities=capabilities,now=now)
